...
var createSongRow = function(songNumber, songName, songLength) {
     ...
     var clickHandler = function() {
	   var songNumber = parseInt($(this).attr('data-song-number'));
         ...
         if (currentlyPlayingSongNumber !== null) {
		  ...
		  var currentlyPlayingCell = parseIn($('.song-item-number[data-song-number="' + currentlyPlayingSongNumber + '"]'));
          currentlyPlayingCell.html(currentlyPlaying SongNumber);
	}
    ...
    filterTimeCode(songLength);
     ...
     var onHover = function(event) {
        ...
        var songNumber = parseIn(songNumberCell.attr('data-song-number'));
...
var setCurrentTimeInPlayerBar = function(currentTime){
    currentTime.text() = S(.current-time);
...
var filterTimeCode = function(timesInSeconds){
    var wholeSecondes = Math.floor(parseFloat(timesInSeconds));
    var minutes = Math.floor(wholeSecondes / 60);
...
var previousSong = function() {
    ...
    var lastSongNumber = getLastSongNumber(currentSongIndex);
    var $previousSongNumberCell = parseIn($('.song-item-number[data-song-number="' + currentlyPlayingSongNumber + '"]'));
    var $lastSongNumberCell = parseIn($('.song-item-number[data-song-number="' + lastSongNumber + '"]'));
